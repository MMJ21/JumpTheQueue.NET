...
namespace Devon4Net.Application.WebAPI.Implementation.Business.MediatRManagement.Handlers
{
    ...
    public class CreateTodoHandler : MediatrRequestHandler<CreateTodoCommand, TodoResultDto>
    {
        ...
        public CreateTodoHandler(ITodoService todoService, IMediatRBackupService mediatRBackupService,
            IMediatRBackupLiteDbService mediatRBackupLiteDbService) : base(mediatRBackupService,
        ...
        /// <param name="todoService"></param>
        /// <param name="mediatRBackupLiteDbService"></param>
        public CreateTodoHandler(ITodoService todoService, IMediatRBackupLiteDbService mediatRBackupLiteDbService) :
            base(mediatRBackupLiteDbService)
        {
            Setup(todoService);
        }
        ...
        /// <param name="todoService"></param>
        /// <param name="mediatRBackupService"></param>
        public CreateTodoHandler(ITodoService todoService, IMediatRBackupService mediatRBackupService) : base(
        ...
        /// <returns></returns>
        public override async Task<TodoResultDto> HandleAction(CreateTodoCommand request,
