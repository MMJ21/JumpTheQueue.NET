...
namespace Devon4Net.Application.WebAPI.Implementation.Business.MediatRManagement.Handlers
{
    ...
    public class GetTodoHandler : MediatrRequestHandler<GetTodoQuery, TodoResultDto>
    {
        ...
        public GetTodoHandler(ITodoService todoService, IMediatRBackupService mediatRBackupService,
        ...
        /// <param name="todoService"></param>
        /// <param name="mediatRBackupLiteDbService"></param>
        public GetTodoHandler(ITodoService todoService, IMediatRBackupLiteDbService mediatRBackupLiteDbService) : base(
            mediatRBackupLiteDbService)
        {
            Setup(todoService);
        }
        ...
        /// <param name="todoService"></param>
        /// <param name="mediatRBackupService"></param>
        public GetTodoHandler(ITodoService todoService, IMediatRBackupService mediatRBackupService) : base(
        ...
        /// <returns></returns>
        public override async Task<TodoResultDto> HandleAction(GetTodoQuery request,
